...
#define kDefaultTintColor       RGB(11, 32, 53)
...
- (void)setSelectTitleColor:(UIColor *)selectTitleColor{
    ...
    if (_selectTitleColor != selectTitleColor) {
...
- (void)ItemStateChanged:(RFSegmentItem *)currentItem index:(NSInteger)index isSelected:(BOOL)isSelected
{
    ...
    currentItem.titleLabel.textColor = _selectTitleColor;
